...
func TestRFC6724CommonPrefixLength(t *testing.T) {
	tests := []struct {
		...
		{netip.MustParseAddr("fe80::1"), net.ParseIP("fe80::2"), 64},
		{netip.MustParseAddr("fe81::1"), net.ParseIP("fe80::2"), 15},
		{netip.MustParseAddr("127.0.0.1"), net.ParseIP("fe80::1"), 0}, // diff size
		{netip.AddrFrom4([4]byte{1, 2, 3, 4}), net.IP{1, 2, 3, 4}, 32},
		{netip.AddrFrom4([4]byte{1, 2, 255, 255}), net.IP{1, 2, 0, 0}, 16},
		{netip.AddrFrom4([4]byte{1, 2, 127, 255}), net.IP{1, 2, 0, 0}, 17},
		{netip.AddrFrom4([4]byte{1, 2, 63, 255}), net.IP{1, 2, 0, 0}, 18},
		{netip.AddrFrom4([4]byte{1, 2, 31, 255}), net.IP{1, 2, 0, 0}, 19},
		{netip.AddrFrom4([4]byte{1, 2, 15, 255}), net.IP{1, 2, 0, 0}, 20},
		{netip.AddrFrom4([4]byte{1, 2, 7, 255}), net.IP{1, 2, 0, 0}, 21},
		{netip.AddrFrom4([4]byte{1, 2, 3, 255}), net.IP{1, 2, 0, 0}, 22},
		{netip.AddrFrom4([4]byte{1, 2, 1, 255}), net.IP{1, 2, 0, 0}, 23},
		{netip.AddrFrom4([4]byte{1, 2, 0, 255}), net.IP{1, 2, 0, 0}, 24},
	}
	for i, tt := range tests {
